...
if __name__ == '__main__':
    examples = sys.argv[0] + " -p ${RABBITMQ_DEFAULT_PORT} -s ${RABBITMQ_DEFAULT_SERVICE} -m ${RABBITMQ_DEFAULT_MESSAGE} "
    ...
    parser.add_argument('-m', '--message', action='store', dest='message', help='The message to send', required=False, default="${RABBITMQ_DEFAULT_MESSAGE}")
